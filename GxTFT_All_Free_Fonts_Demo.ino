...
#include "myTFTs/my_3.2_TFT_320x240_ILI9341_STM32F4.h"  //fsmc
...
#include "TGURTouch.h"
TGURTouch  myt(PB13, PB12, PB15, PB14, PC5);
...
void loop()
{
	...
	tft.drawString("Toucher l'ecran", x_center, y_one_fourth, GFXFF);  // Print the string name of the font
	while (!myt.dataAvailable());
	...
	tft.setFreeFont(FF18);                 // Select the font
	tft.drawString("x:",6, 20, GFXFF);
	tft.drawString("y:",128, 20, GFXFF);

	tft.drawNumber(x, 6+28, 20);              // Print the string name of the font
	tft.drawNumber(y, 128+28, 20);            // Print the string name of the font
	tft.drawString("Attente 1500ms", x_center, y_one_fourth, GFXFF);// Print the string name of the font
	delay(1500);
